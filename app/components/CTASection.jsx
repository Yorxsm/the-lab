            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="mailto:joel@exhibot.ng" className="inline-flex items-center justify-center px-8 py-4 bg-[#ff6b35] text-white font-display font-semibold rounded-md hover:bg-[#e55a2a] transition-colors text-base md:text-lg">
                            Start a Project
                        </a>
